...
def is_topic_safe(topic, provider, model_name):
    """Check if a topic is safe for educational content generation."""
    safety_check_prompt = f"""
CRITICAL SAFETY CHECK - You MUST respond with ONLY "SAFE" or "UNSAFE"

Topic to evaluate: "{topic}"

Is this topic appropriate for educational notes generation? Consider:

**UNSAFE TOPICS (respond UNSAFE for these):**
- Illegal activities (drugs, weapons, crime, hacking)
- Harmful or dangerous content (self-harm, violence)
- Adult/explicit content
- Hate speech, discrimination, harassment
- Cheating, academic dishonesty, plagiarism
- Fraud, scams, unethical practices
- Dangerous experiments without safety
- Terrorism, extremism, radicalization
- Any content that could cause harm

**SAFE TOPICS (respond SAFE for these):**
- Academic subjects (math, science, history, etc.)
- Professional skills (programming, business, etc.)
- Creative arts (writing, music, art)
- Health and wellness (educational content only)
- Technology and computing
- Languages and communication
- Personal development
- Any legitimate educational topic

Respond with ONLY one word: "SAFE" or "UNSAFE"
"""

    try:
        response, error = generate_direct_llm_response(
            provider, model_name, safety_check_prompt
        )
